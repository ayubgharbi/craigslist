...
Category.create!([
    ...
    { name: "last+found", url: "last-found", parent_id: 1 },
...
Category.create!([
    { name: "automative", url: "automative", parent_id: 2 },
    ...
    { name: "write/ed/tran", url: "write-ed-translate", parent_id: 2 },
])
...
Category.create!([
    ...
    { name: "fixit", url: "fixed", parent_id: 3 },
...
Category.create!([
    { name: "apts / housing", url: "apts", parent_id: 4 },
...
Category.create!([
    ...
    { name: "beauty+hlth", url: "beauty-health", parent_id: 5 },
    { name: "bike parts", url: "bike-parts", parent_id: 5 },
    { name: "bikes", url: "bikes", parent_id: 5 },
    { name: "boat", url: "boat", parent_id: 5 },
    ...
    { name: "clothes+acc", url: "clothes-accessories", parent_id: 5 },
    ...
    { name: "jewerly", url: "jewerly", parent_id: 5 },
    ...
    { name: "music instr", url: "music-instruments", parent_id: 5 },
